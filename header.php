                                        ...
                                        <div class="cart_submenu">
                                            ...
                                            ?>
                                                <div class="cart_wrap">
                                                    ...
                                                    <a href="<?php echo $woocommerce->cart->get_cart_url(); ?>" class=" shortcode_button btn_small btn_type5 mr15"><?php esc_html_e('View cart', 'hershel'); ?></a>
                                                    <a href="<?php echo $woocommerce->cart->get_checkout_url(); ?>" class=" shortcode_button btn_small btn_type4 mr0"><?php esc_html_e('Checkout', 'hershel'); ?></a>
                                                </div>
                                            <?php
                                            } else {
                                            ?>
